...
export default function AgentInboxPage() {
  ...
  // 👇 YA NO USAMOS loading acá, eso lo maneja ProtectedRoute
  const { supabase, tenant, profile, session } = useAuth();
        ...
        <section className="flex-1 p-4">
          {noTenant ? (
            <div className="flex h-full items-center justify-center text-sm text-muted-foreground border border-dashed border-border rounded-xl">
              No tenés un tenant asociado todavía. Completa el registro de tu
